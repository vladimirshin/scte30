 ...
 * Type 0x0007 is utilized by VOD and Ad Servers where remapping of PIDs is impractical or undesirable.
 * In these cases it is desirable to use a SPTS per UDP Port.
 * @author Vladimir Shin [vladimir.shin@gmail.com]
 */
public class IPV6AddressSPTSSupportMultiplex extends LogicalMultiplex {
